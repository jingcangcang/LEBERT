...
from wcbert_modeling import WCBertCRFForClassification
from module.sampler import SequentialDistributedSampler
from feature.task_dataset_classfier import TaskDatasetClassfier
from feature.vocab import ItemLabelFile, ItemVocabArray
...
def main():
    ...
    label_vocab = ItemLabelFile(files=[args.label_file])
    tokenizer = BertTokenizer.from_pretrained(args.vocab_file)
    ...
    model = WCBertCRFForClassification.from_pretrained(
    ...
    if args.do_train:
        train_dataset = TaskDatasetClassfier(train_data_file, params=dataset_params, do_shuffle=args.do_shuffle)
        dev_dataset = TaskDatasetClassfier(dev_data_file, params=dataset_params, do_shuffle=False)
        test_dataset = TaskDatasetClassfier(test_data_file, params=dataset_params, do_shuffle=False)
